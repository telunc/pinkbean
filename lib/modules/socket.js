...
var socket = _socket2.default.connect(_config2.default.get('server'));
...
exports.default = function (client) {
    ...
    socket.on('timer', async function (data) {
        ...
        guilds.forEach(async function (guild) {
            ...
            await channel.fetchMessage(guild.timer_message).then(function (message) {
                message.edit(text).catch(function () {
                    sendMessage();
                });
            ...
            async function sendMessage() {
                ...
                channel.send(text).then(function (message) {
                    ...
                    _guild2.default.updateGuildWithId(guild.id, guild);
                });
            }
        });
    });

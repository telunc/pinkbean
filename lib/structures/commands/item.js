...
exports.default = async function (tokens, message) {
    ...
    var image = 'http://www.pinkbean.xyz/api/item/' + name + '/icon';
    var description = void 0,
        category = void 0;
    var subCategory = item.typeInfo ? item.typeInfo.category : null;
    var detailCategory = item.typeInfo ? item.typeInfo.subCategory : null;
